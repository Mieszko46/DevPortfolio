...
import com.gaska.runnercup.utils.Constants.MAXIMUM_PASSWORD_LENGTH
import com.gaska.runnercup.utils.Constants.MINIMUM_PASSWORD_LENGTH
...
class UserViewModel @Inject constructor(
    ...
    fun createUser(
        ...
        _registerState.emit(planRepo.createUser(newUser))
    }
    ...
    fun loginUser(
        ...
        _loginState.emit(planRepo.login(newUser))
    }


    fun getCurrentUser()  = viewModelScope.launch{
        _currentUserState.emit(Result.Loading())
        _currentUserState.emit(planRepo.getUser())
    }

    fun logout() = viewModelScope.launch {
        val result = planRepo.logout()
